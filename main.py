...
sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").sheet1
days_off_sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").worksheet("DaysOff")
users_sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").worksheet("Users")
settings_sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").worksheet("Settings")
active_breaks_sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").worksheet("ActiveBreaks")
blocked_users_sheet = client.open_by_key("1bcEkHPMTyYD2TQvWwZEbyOeQCN4FcmJYq5IjVLYg2-Q").worksheet("BlockedUsers")
